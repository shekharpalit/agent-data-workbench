"""SQLAlchemy trace storage with deterministic samples and bounded read tools."""
...
from .database import TraceRow, trace_engine
    ...
    def select(
        ...
        *,
        ...
        if equals_pointer is not None:
            from .models import _reject_constant, pointer_parts
